...
?> 
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <button type="button" class="btn btn-warning text-white" id="sunting" title="Sunting" onclick="openModal('Lihat', '<?= $page ?>')"><i class="nav-icon fas fa-pencil-alt"></i></button>
              <button type="button" class="btn btn-success" id="selesai" title="Selesai" onclick="openModal('Selesai', '<?= $page ?>')"><i class="nav-icon fas fa-check"></i></button>
            </div>
            <div class="card-body">
  ...
  <?php include_once 'modul/ticket/inc/modal.php'; ?>
